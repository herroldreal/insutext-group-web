                    ...
                    <div className="col-lg-3 col-md-4 pq-border-right">
                        <div className="pq-counter pq-counter-default">
                            <div className="pq-counter-num-prefix">
                                <h5 className="timer" data-to="6050" data-speed="5000">11</h5>
                            </div>
                            <span className="pq-counter-title">Nuestras marcas</span>
                        </div>
                    </div>
                            ...
                            <div className="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="false"
                                ...
                                <div className="item">
                                    <div className="pq-client-box pq-style-1">
                                        <div>
                                            <img decoding="async" src="/images/client/slider/1.svg" alt="pq-client-img"
                                                 className="pq-client-img"/>
                                            <img decoding="async" src="/images/client/slider/h1.svg" alt="pq-client-img"
                                ...
                                <div className="item">
                                    <div className="pq-client-box pq-style-1">
                                        <div>
                                            <img decoding="async" src="/images/client/slider/2.svg" alt="pq-client-img"
                                                 className="pq-client-img"/>
                                            <img decoding="async" src="/images/client/slider/h2.svg" alt="pq-client-img"
                                                 className="pq-client-hover-img"/>
                                        </div>
                                    </div>
                                </div>
